...
public class TemplateConstants {
    ...
    public static final String GENCODE_SERVICE_INTERFACE = "gencode/service_interface.ftl";
    ...
    public static final String SERICE_INTERFACE_FULL_TYPE = "serviceInterfaceFullType";
